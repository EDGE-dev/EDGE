...
static const int64_t MAX_MONEY = 50000000 * COIN; // 1M PoW coins
...
class CDiEDGElockIndex : public CBlockIndex
{
private:
    uint256 blockHash;
...
public:
    ...
    explicit CDiEDGElockIndex(CBlockIndex* pindex) : CBlockIndex(*pindex)
    {
    ...
    (
        ...
        {
            const_cast<CDiEDGElockIndex*>(this)->prevoutStake.SetNull();
            const_cast<CDiEDGElockIndex*>(this)->nStakeTime = 0;
        }
        READWRITE(hashProof);
    ...
    uint256 GetBlockHash() const
    {
        ...
        const_cast<CDiEDGElockIndex*>(this)->blockHash = block.GetHash();
    ...
    std::string ToString() const
    {
        std::string str = "CDiEDGElockIndex(";
