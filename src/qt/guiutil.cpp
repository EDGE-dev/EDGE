...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "edge.lnk";
}
...
{
    return GetAutostartDir() / "edge.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("edge-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  edge-qt [" + tr("command-line options") + "]                     " + "\n";
