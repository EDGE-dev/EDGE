...
enum AvailableCoinsType
{
    ...
    ONLY_NONDENOMINATED_NOTMN = 4 // ONLY_NONDENOMINATED and not 1000 EDGE at the same time
};
...
public:
    ...
    std::map<std::string, CedgeNodeConfig> mapMyedgeNodes;
    bool AddedgeNodeConfig(CedgeNodeConfig nodeConfig);
