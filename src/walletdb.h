...
public:
    ...
    bool WriteedgeNodeConfig(std::string sAlias, const CedgeNodeConfig& nodeConfig);
    bool ReadedgeNodeConfig(std::string sAlias, CedgeNodeConfig& nodeConfig);
    bool EraseedgeNodeConfig(std::string sAlias);
